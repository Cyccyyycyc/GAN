...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.init_size = opt.img_size // 16  # 除法下取整等于2
...
os.makedirs("../net-module/V4W/Generator", exist_ok=True)
os.makedirs("../net-module/V4W/Discriminator", exist_ok=True)
...
def sample_image(n_row, order):
    ...
    os.makedirs("../images/Cifar10-images/CDCGAN-W-V4",exist_ok=True)
    save_image(gen_imgs.data, "../images/Cifar10-images/CDCGAN-W-V4/%d.png" % order, nrow=n_row, normalize=True)
...
for epoch in range(opt.n_epochs):
    for i, (imgs, labels) in enumerate(dataloader):
        ...
        if i % opt.n_critic == 0:
            ...
            loss_G.backward()  #Specify retain_graph=True
            optimizer_G.step()
    ...
    if (epoch + 1) % opt.save_interval == 0:
        torch.save(generator, "../net-module/V4W/Generator/G{}".format(epoch / opt.sample_interval))
        torch.save(discriminator, "../net-module/V4W/Discriminator/D{}".format(epoch / opt.sample_interval))
