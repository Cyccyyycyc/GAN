...
os.makedirs("../net-module/V7W/Generator", exist_ok=True)
os.makedirs("../net-module/V7W/Discriminator", exist_ok=True)
...
def sample_image(n_row, order):
    ...
    os.makedirs("../images/Cifar10-images/CDCGAN-W-V7",exist_ok=True)
    save_image(gen_imgs.data, "../images/Cifar10-images/CDCGAN-W-V7/%d.png" % order, nrow=n_row, normalize=True)
