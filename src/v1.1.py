...
model_save_path = "../net-module/V8W"
img_save_path = "../images/Cifar10-images/CDCGAN-W-V8"
...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(opt.latent_dim + opt.n_classes, 256 * self.init_size ** 2))
